...
public class IntParam extends BaseStatParam {
	

	/**
	 * @param field
	 */
	public IntParam(FieldBean field) {
		super(field);
	...
	public void psSetValue(PreparedStatement ps, int count, Object value) throws Exception {
		if (value == null || (field.getTableUpdate()==TableUpdate.EMPTYZERO_NULL && (Integer)value==0))
