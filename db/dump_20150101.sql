...
DELETE FROM `attachment_deleted`;
...
-- Dumping structure for table tablet_menu.category_2_daily_menu
CREATE TABLE IF NOT EXISTS `category_2_daily_menu` (
  ...
  CONSTRAINT `category_2_daily_menu_ibfk_2` FOREIGN KEY (`category_id`) REFERENCES `category` (`_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `category_2_daily_menu_ibfk_1` FOREIGN KEY (`daily_menu`) REFERENCES `daily_menu` (`_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

-- Dumping data for table tablet_menu.category_2_daily_menu: ~2 rows (approximately)
DELETE FROM `category_2_daily_menu`;
/*!40000 ALTER TABLE `category_2_daily_menu` DISABLE KEYS */;
INSERT INTO `category_2_daily_menu` (`_id`, `daily_menu`, `category_id`, `item_order`) VALUES
	(5, 4, 1, 1),
	(6, 4, 16, 4);
/*!40000 ALTER TABLE `category_2_daily_menu` ENABLE KEYS */;
...
DELETE FROM `category_2_language`;
...
INSERT INTO `category_2_language` (`_id`, `id_category`, `lang`, `title`, `subtitle`, `body`, `creation_date`, `update_date`, `deleted`) VALUES
	...
	(10, 16, 'it_IT', 'Dolci', '<i>Le delizie piÃ¹ fresche e buone</i><br>', '<br>', '2012-08-09 17:11:13', '2012-08-23 17:02:48', NULL),
...
INSERT INTO `currency` (`_id`, `label`, `symbol`, `symbol_html`, `struts_format`, `digit`, `separator_decimal`, `separator_thousand`) VALUES
	(1, 'EUR', 'â‚¬', '&#128;', '{0,number,##0.00}', 2, ',', '\''),
	(2, 'USD', '$', '&#36;', '{0,number,##0.00}', 2, '.', ','),
	(3, 'GBP', 'Â£', '&#163;', '{0,number,##0.00}', 2, '.', ','),
	(4, 'YEN', 'Â¥', '&#165;', '{0,number,##0}', 0, '', ',');
/*!40000 ALTER TABLE `currency` ENABLE KEYS */;


-- Dumping structure for table tablet_menu.daily_menu
CREATE TABLE IF NOT EXISTS `daily_menu` (
  ...
  PRIMARY KEY (`_id`),
  KEY `domain` (`domain`),
  CONSTRAINT `daily_menu_ibfk_1` FOREIGN KEY (`domain`) REFERENCES `domain` (`_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8;

-- Dumping data for table tablet_menu.daily_menu: ~14 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `discount_policy` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `recurring` bit(8) NOT NULL COMMENT 'Meno significativa = lunedi',
...
INSERT INTO `discount_policy` (`id`, `recurring`, `fromtime`, `totime`, `fixed_price`, `perc_discount`, `active`, `priority_order`) VALUES
	...
	(16, b'11111101', '14:00:00', '20:00:00', -1.00, -10, 0, 2),
...
INSERT INTO `domain` (`_id`, `label`, `description`, `system`, `active`, `creation_date`, `device_key`, `unlock_key`) VALUES
	...
	(2, 'OXY', 'OxyBay Consulting S.L.', 0, 1, '2012-07-12 16:56:31', '1gz3cg', '8624'),
...
INSERT INTO `language` (`label`, `description`, `active`, `application`, `_id`) VALUES
	...
	('de_DE', 'Deutsch', 1, 1, 3),
	('en_EN', 'English', 1, 1, 4),
	('es_ES', 'EspaÃ±ol', 1, 1, 5),
	('fi_FI', 'Suomi', 1, 0, 6),
	('fr_FR', 'FranÃ§ais', 1, 1, 7),
	('hu_HU', 'Hrvatski', 1, 0, 8),
	('it_IT', 'Italiano', 1, 1, 9),
	('nl_NL', 'Nederlands', 1, 0, 10),
	('no_NO', 'Norsk', 1, 0, 11),
	('pt_PT', 'PortuguÃªs', 1, 1, 12),
	('ru_ru', 'Ð ÑƒÑÑÐºÐ¸Ð¹', 1, 0, 14),
	('sv_SV', 'Svenska', 1, 0, 13);
/*!40000 ALTER TABLE `language` ENABLE KEYS */;


-- Dumping structure for table tablet_menu.language_label
CREATE TABLE IF NOT EXISTS `language_label` (
  ...
  `deleted` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`_id`),
  KEY `language_label_FK_language_label1` (`lang`),
  CONSTRAINT `FK_language_label1` FOREIGN KEY (`lang`) REFERENCES `language` (`label`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table tablet_menu.language_label: ~0 rows (approximately)
DELETE FROM `language_label`;
/*!40000 ALTER TABLE `language_label` DISABLE KEYS */;
/*!40000 ALTER TABLE `language_label` ENABLE KEYS */;


-- Dumping structure for table tablet_menu.language_label_custom
CREATE TABLE IF NOT EXISTS `language_label_custom` (
  `_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `domain` int(10) unsigned NOT NULL,
  `lang` varchar(5) NOT NULL,
  ...
  `deleted` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`_id`),
  KEY `FK_language_label_custom1` (`domain`),
  KEY `FK_language_label_custom2` (`id_label`),
  CONSTRAINT `FK_language_label_custom1` FOREIGN KEY (`domain`) REFERENCES `domain` (`_id`),
  CONSTRAINT `FK_language_label_custom2` FOREIGN KEY (`id_label`) REFERENCES `language_label` (`_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table tablet_menu.language_label_custom: ~0 rows (approximately)
DELETE FROM `language_label_custom`;
/*!40000 ALTER TABLE `language_label_custom` DISABLE KEYS */;
/*!40000 ALTER TABLE `language_label_custom` ENABLE KEYS */;
...
-- Dumping data for table tablet_menu.menu_2_language: ~6 rows (approximately)
DELETE FROM `menu_2_language`;
/*!40000 ALTER TABLE `menu_2_language` DISABLE KEYS */;
INSERT INTO `menu_2_language` (`_id`, `id_menu`, `lang`, `creation_date`, `update_date`, `deleted`) VALUES
	(16, 3, 'it_IT', NULL, NULL, NULL),
	(17, 3, 'es_ES', NULL, NULL, NULL),
	(18, 3, 'en_EN', NULL, NULL, NULL),
	(19, 3, 'da_DA', '2014-12-31 16:18:01', NULL, NULL),
	(20, 3, 'fi_FI', '2014-12-31 16:18:15', NULL, NULL),
	(21, 3, 'fi_FI', '2014-12-31 16:19:03', NULL, '2014-12-31 16:19:03');
...
DELETE FROM `product_2_category`;
...
-- Dumping structure for table tablet_menu.product_2_daily_menu
CREATE TABLE IF NOT EXISTS `product_2_daily_menu` (
  ...
  CONSTRAINT `product_2_daily_menu_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `product` (`_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `product_2_daily_menu_ibfk_1` FOREIGN KEY (`daily_menu`) REFERENCES `daily_menu` (`_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8;

-- Dumping data for table tablet_menu.product_2_daily_menu: ~2 rows (approximately)
DELETE FROM `product_2_daily_menu`;
/*!40000 ALTER TABLE `product_2_daily_menu` DISABLE KEYS */;
INSERT INTO `product_2_daily_menu` (`_id`, `daily_menu`, `product_id`, `item_order`) VALUES
	(34, 4, 5, 2),
	(35, 4, 20, 3);
/*!40000 ALTER TABLE `product_2_daily_menu` ENABLE KEYS */;
...
DELETE FROM `product_2_discount`;
...
DELETE FROM `product_2_language`;
...
INSERT INTO `product_2_language` (`_id`, `id_product`, `lang`, `title`, `subtitle`, `body`, `creation_date`, `update_date`, `deleted`) VALUES
	...
	(38, 12, 'es_ES', 'Tarta merengue y limÃ²n', '<br>', '<br>', '2012-08-10 10:47:45', NULL, NULL),
	...
	(46, 3, 'es_ES', 'PlÃ tano flambe', '<br>', '<br>', '2012-08-10 10:59:45', '2012-09-10 17:04:24', NULL),
	(47, 14, 'en_EN', 'Fresh Trout in a lemon sauce', '<br>', '<br>', '2012-08-10 11:02:54', '2012-08-10 11:04:37', NULL),
	(48, 14, 'es_ES', 'Trucha fresca con salsa de limÃ²n', '<br>', '<br>', '2012-08-10 11:04:11', NULL, NULL),
	...
	(52, 16, 'es_ES', 'Ensalada de salmÃ²n ahumado', '<br>', '<br>', '2012-08-10 11:35:54', NULL, NULL),
	(53, 2, 'es_ES', 'Salchicha con pimientos', '<br>', '<br>', '2012-08-10 11:39:52', NULL, NULL),
	(54, 17, 'en_EN', 'CrÃ¨me caramel', '<br>', '<br>', '2012-08-10 11:44:44', NULL, NULL),
	(55, 17, 'it_IT', 'CrÃ¨me caramel', '<br>', '<br>', '2012-08-10 11:44:58', NULL, NULL),
...
-- Dumping structure for table tablet_menu.tag_2_daily_menu
CREATE TABLE IF NOT EXISTS `tag_2_daily_menu` (
  `_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `daily_menu` int(10) unsigned NOT NULL,
  `tag_id` int(10) unsigned NOT NULL,
  `item_order` smallint(6) NOT NULL,
  PRIMARY KEY (`_id`),
  KEY `FK_tag_2_daily_menu_daily_menu` (`daily_menu`),
  KEY `FK_tag_2_daily_menu_tag` (`tag_id`),
  CONSTRAINT `FK_tag_2_daily_menu_tag` FOREIGN KEY (`tag_id`) REFERENCES `tag` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_tag_2_daily_menu_daily_menu` FOREIGN KEY (`daily_menu`) REFERENCES `daily_menu` (`_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table tablet_menu.tag_2_daily_menu: ~0 rows (approximately)
DELETE FROM `tag_2_daily_menu`;
/*!40000 ALTER TABLE `tag_2_daily_menu` DISABLE KEYS */;
/*!40000 ALTER TABLE `tag_2_daily_menu` ENABLE KEYS */;
